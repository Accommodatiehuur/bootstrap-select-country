var countrypicker = (function ($) {
  ...
  var codes = ( codes$2 && codes$1 ) || codes$2;
  ...
  var isValid = function (code) {
    return alpha3.hasOwnProperty(code) || alpha2.hasOwnProperty(code) || numeric.hasOwnProperty(code);
  };
  ...
  i18nIsoCountries.registerLocale(langs_nl);
  i18nIsoCountries.registerLocale(langs_en);
  i18nIsoCountries.registerLocale(langs_de);
  i18nIsoCountries.registerLocale(langs_fr);

  // Mapping country names with their codes
  var countriesList = function countriesList(locale) {
  	var langCountries = i18nIsoCountries.getNames(locale);
  	var countries_sorted = Object.keys(langCountries).map(function (code) {
  		return {
